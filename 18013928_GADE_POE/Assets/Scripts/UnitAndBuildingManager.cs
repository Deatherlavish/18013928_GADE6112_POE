...
namespace GADE6112___Task3 {
    class UnitAndBuildingManager : MonoBehaviour{
        ...
        public Unit RedmeleeUnitTemplate;
        public Unit BluemeleeUnitTemplate;
        public Unit RedrangedUnitTemplate;
        public Unit BluerangedUnitTemplate;
        public Unit wizardUnitTemplate;
        public Building RedfactoryBuildingTemplate = null;
        public Building BluefactoryBuildingTemplate = null;
        public Building RedresourcebuildingTemplate = null;
        public Building BlueresourcebuildingTemplate = null;
        Building building = null;
        GameObject buildingGameObject = null;
        public void CreateBuilding(BuildingType buildingType, int x, int y, string faction);
        ...
        private List<Target> GetPossibleTargets(string[] ignoreFactions, bool includeUnits, bool includeBuildings) {
            ...
            foreach (string faction in factions) {
                ...
                if (includeUnits) {
                    //EDIT->targets.AddRange(units[faction]);
                }
                //include buildings in list if includeUnits is set to true
                if (includeBuildings) {
                    //EDIT->targets.AddRange(buildings[faction]);
                }
            }
            return targets;
        }

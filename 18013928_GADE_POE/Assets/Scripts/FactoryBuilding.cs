...
namespace GADE6112___Task3
{
    ...
    class FactoryBuilding : Building
    {
        ...
        public FactoryBuilding(int x, int y, string faction, int mapHeight) : base(x, y, 100, faction, '~') {
            ...
            //EDIT-> type = (FactoryType) GameEngine.random.Next(0, 2);
            //EDIT-> productionSpeed = GameEngine.random.Next(3, 7);
            //EDIT->spawnCost = GameEngine.random.Next(15, 25);
        }
        ...
        public override string Save() {
            //EDIT-> return string.Format($"Factory,{x},{y},{health},{maxHealth},{(int)type},{productionSpeed},{spawnY},{faction},{symbol},{isDestroyed}");
